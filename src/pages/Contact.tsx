            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Send us a message and we'll respond as soon as possible. All communications are treated confidentially.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        placeholder="Please provide details about your inquiry, including any relevant property information, timeline, and specific issues you're experiencing..."
